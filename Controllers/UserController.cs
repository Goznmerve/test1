...
namespace WebApplication5.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        private readonly IMapper _mapper;//IMapper interface'i AutoMapper'ın bağımlılığını enjekte etmemizi sağlıyor
        ...
        public IActionResult Index()
        {
            List<UserModel> users =
                ...
                .Select(x => _mapper.Map<UserModel>(x)).ToList();// önce dataları çek, sonra herbirini gez ortadaki
                                                                 // tolist olamzsa SQL'e çevirmeye çalışır
